...
### Frontend (Flutter)
- **Flutter 3.x+** - Cross-platform framework for iPad and Web from single codebase
- **Dart** - Primary programming language for Flutter
- **State Management** - Riverpod or Bloc (recommended for offline-first patterns)
- **Local Storage** - drift/sqflite for offline relational database
- **Secure Storage** - flutter_secure_storage (iOS Keychain integration)
- **HTTP Client** - dio with interceptors for JWT authentication and caching
- **PDF Handling** - file_picker (upload), pdf/printing (generation), syncfusion_flutter_pdfviewer (display)
- **Charts & Visualization** - fl_chart or syncfusion_flutter_charts for savings graphs
- **Responsive Design** - LayoutBuilder and MediaQuery for iPad/Web adaptability
- **Component-based architecture** - Reusable widget components with clean architecture
